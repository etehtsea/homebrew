require 'homebrew/download_strategy'
require 'homebrew/dependencies'
require 'homebrew/formula_support'
require 'homebrew/extend/fileutils'
...
module Homebrew
  ...
  private
    ...
    class << self
      ...
      # Public: Method is used to declare dependencies and requirements.
      def depends_on dep
...
require 'homebrew/formula_specialties'
